...
class PermissionTest extends TestCase
{
    ...
    public function test_can_access_list_permission()
    {
        ...
        $user->attachPermissions([
            Permission::factory()->create(['name' => 'permission-view']),
            Permission::factory()->create(['name' => 'permission-create']),
            Permission::factory()->create(['name' => 'permission-update']),
        ]);
    ...
    {
        $user = User::factory()->create();
        $user->attachPermission(Permission::factory()->create(['name' => 'permission-create']));
        $this->actingAs($user);
    ...
    {
        $user = User::factory()->create();
        $user->attachPermission(Permission::factory()->create(['name' => 'permission-update']));
        $this->actingAs($user);
