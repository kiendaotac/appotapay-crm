...
class RoleTest extends TestCase
{
    ...
    public function test_can_access_list_role()
    {
        ...
        $user->attachPermissions([
            Permission::factory()->create(['name' => 'role-view']),
            Permission::factory()->create(['name' => 'role-create']),
            Permission::factory()->create(['name' => 'role-update']),
        ]);
    ...
    {
        $user = User::factory()->create();
        $user->attachPermission(Permission::factory()->create(['name' => 'role-create']));
        $this->actingAs($user);
    ...
    {
        $user = User::factory()->create();
        $user->attachPermission(Permission::factory()->create(['name' => 'role-update']));
        $this->actingAs($user);
        $role = Role::create([
            'name' => '::role.name::',
            'display_name' => '::role.display_name::',
