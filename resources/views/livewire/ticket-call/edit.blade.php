    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                <a href="{{ route('ticket.calls.index') }} " class="btn btn-default btn-bold">
                    Quay lại
                </a>
            </div>
        </div>
                                    ...
                                    <div class="kt-notes__items">
                                        ...
                                        <div class="kt-notes__item">
                                            <div class="kt-notes__media">
                                                <img class="kt-hidden-" src="{{ optional($item->causer)->avatar_url }}"
                                                    alt="image">
                                            </div>
                                                ...
                                                <div class="kt-notes__section">
                                                    <div class="kt-notes__info">
                                                        <a href="javascript:void(0)" class="kt-notes__title"
                                                            data-toggle="kt-tooltip" role="button" data-trigger="focus"
