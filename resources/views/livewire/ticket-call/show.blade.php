<div>
    <div wire:ignore.self class="modal fade" id="show-ticket-call-modal" tabindex="-1" role="dialog"
        aria-labelledby="show-ticket-call-label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="show-ticket-call-label">
                        Xem trước ticket
                    </h5>
                                    ...
                                    <x-bootstrap.accordion title="">
                                        <div class="kt-section kt-section--first">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="{{ route('ticket.calls.index', ['tag' => $item->name]) }}"
