                ...
                <template x-if="item.id == __user__.id">
                    <div class="kt-chat__message kt-chat__message--right">
                        <div class="kt-chat__user">
                            <span class="kt-chat__datetime" data-container="body" data-toggle="kt-tooltip"
                                data-placement="top" x-bind:data-original-title="item.pivot.created_at"
                                x-text="item.pivot.diff_for_now"></span>
...
<script>
    function setup_list_comment_ticket() {
        return {
            comments: @entangle('comments').defer,
