                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="kt_table_1">
                    ...
                    <tbody>
                        ...
                        <tr wire:key="{{ $user->id }}">
                            ...
                            <td>
                                <span
                                    class="kt-badge kt-badge--{{ $user->status_decoration['color'] }} kt-badge--dot"></span>
                                &nbsp;
                                <span class="kt-font-bold kt-font-{{ $user->status_decoration['color'] }}">
                                    {{ $user->status_decoration['value'] }}
                                </span>
                            </td>
