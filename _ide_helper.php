 ...
 */
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Mail\MailManager         
                        /** @var \App\Libraries\Mailer\ApayMailManager $instance */
         ...
         * @param string $driver
         * @param \Closure $callback
         * @return \App\Libraries\Mailer\ApayMailManager 
         * @static 
         */ 
        public static function extend($driver, $callback)
        {            //Method inherited from \Illuminate\Mail\MailManager         
...
')
     ...
     */ 
        ...
        {
                        return \Illuminate\Support\Str::normalizePhone($phone);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function composeTicketLink($id, $type)
        {
                        return \Illuminate\Support\Str::composeTicketLink($id, $type);
        }
     ...
     */ 
        ...
        {
                        return \Illuminate\Support\Stringable::normalizePhone();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Stringable::stripTags();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function entitiesDecode()
        {
                        return \Illuminate\Support\Stringable::entitiesDecode();
        }
     ...
     */ 
         ...
         * @param \BotMan\BotMan\Interfaces\DriverInterface|null $driver
